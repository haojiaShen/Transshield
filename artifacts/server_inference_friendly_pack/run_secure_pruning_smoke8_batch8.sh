...
# batch_size=8 = all 8 samples in 1 spu_run
RUN_NAME="${RUN_NAME:-secure_pruning_spu_smoke8_batch8_partylocal_secret_20260510_1}"
...
echo "=== Secure Pruning smoke8 batch8 (PredictorLG in-SPU, batch_size=8) ===" | tee "$LOG_FILE"
