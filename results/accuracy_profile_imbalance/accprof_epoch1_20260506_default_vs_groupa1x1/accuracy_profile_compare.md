...
- candidate `secure_static_accprof_epoch1_20260506_groupa1x1` test_acc1: `81.6793915260839`
- delta candidate-baseline test_acc1: `0.1908399276151016`
- delta candidate-baseline train_loss: `-2.690723964082764e-06`

## 3. 明文评估对照

- threshold_accuracy delta: `0.0`
- auc delta: `0.0004760544606302597`
