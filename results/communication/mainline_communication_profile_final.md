...
- 参考主线：医疗动态安全推理正式主线（内部运行标识：`medical_dynamic_mainline_final`）
- 通信复核：同配置通信量复核运行（内部运行标识：`medical_dynamic_commprofile_final`）
- 样本数：`32`
...
- 参考主线：金融动态安全推理正式主线（内部运行标识：`finance_dynamic_mainline_final`）
- 通信复核：同配置通信量复核运行（内部运行标识：`finance_dynamic_commprofile_final`）
- 样本数：`8`
