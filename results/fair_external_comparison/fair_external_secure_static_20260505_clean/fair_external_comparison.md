...
|---|---:|---:|---:|---:|---|
| Transshield modified + secure replay | 524 | 75.190842 | 90.076333 | 0.958431 | `/data/wyb/Transshield_final/artifacts/server_pipeline_run/delivery_line_suite_20260505_clean/plaintext_modified_eval.json` |
| MPCViT | 524 | 96.183206 | 96.183206 | 0.992564 | `/data/wyb/Transshield_final/results/fair_external_comparison/fair_external_secure_static_20260505_clean/mpcvit/summary_multiseed.json` |

## 差值

| 指标 | Transshield - MPCViT |
|---|---:|
| Argmax Acc | -20.992364 pt |
| Threshold Acc | -6.106873 pt |
| AUC | -0.034133 |
...
|---|---:|---|---:|---:|---|---|---|
| Transshield SPU secure sidecar | 524 | N/A | N/A | N/A | not_run_secure | false | 当前没有外部模型在同数据集、同输入、同协议路径下的 secure 通信结果。 |
