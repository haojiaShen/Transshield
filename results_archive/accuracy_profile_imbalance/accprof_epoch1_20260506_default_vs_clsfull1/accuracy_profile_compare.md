...
- candidate `secure_static_accprof_epoch1_20260506_clsfull1` test_acc1: `81.4885515984688`
- delta candidate-baseline test_acc1: `0.0`
- delta candidate-baseline train_loss: `-1.3826655687054767e-07`
...
- `cls_token_full_lr`: baseline=`false` candidate=`true`
