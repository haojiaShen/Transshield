...
- candidate `secure_static_accprof_epoch1_20260507_clip2_1` test_acc1: `81.6793915260839`
- delta candidate-baseline test_acc1: `0.1908399276151016`
- delta candidate-baseline train_loss: `0.0002243289736663101`

## 3. 明文评估对照

- threshold_accuracy delta: `0.0`
- auc delta: `-0.0008378558507092793`
- argmax_accuracy delta: `0.1908421516418457`

## 4. 配置差异

- `clip_grad`: baseline=`1.0` candidate=`2.0`
