...
def build_final_env_template():
    return join_shell_lines(
        ...
        'export RUN_DIR=/data/wyb/Transshield_final/artifacts/server_runs/${RUN_NAME}',
        'export BUNDLE_DIR=/data/wyb/Transshield_final/artifacts/server_bundles/${RUN_NAME}_bundle',
        'export SECURE_RUN_DIR=/data/wyb/Transshield_final/artifacts/server_pipeline_run/${RUN_NAME}',
        'export CONFIG_PATH=/data/wyb/Transshield_final/configs/openbumblebee/2pc.json',
