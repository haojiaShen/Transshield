...
def get_args_parser():
    ...
    parser.add_argument('--model', default='deit-s', choices=['deit-s'], type=str, metavar='MODEL',
                        help='Name of model to train; current TrackA compatibility training only supports deit-s.')
...
def main(args):
    ...
    if args.layer_decay != 1.0:
        raise ValueError('TrackA compatibility training currently only supports deit-s with layer_decay=1.0.')
    assigner = None
